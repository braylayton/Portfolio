...
//	Graphics::MeshBuilder::CreateCylinderSkinned(mCylinderMesh, 1.0f, 50, 3, { 0,1,0 });
...
//	mVertexShader.Initialize(L"../Assets/Shaders/Skinning.fx", "VS", "vs_5_0", Graphics::Vertex::Format);
//	mPixelShader.Initialize(L"../Assets/Shaders/Skinning.fx", "PS", "ps_5_0", Graphics::Vertex::Format);
...
//
//
//	//mBoneTransforms[0].SetScale({ 0.5f, 1.0f, 0.5f });
...
//		}
//
//		mBoneTransforms[i].SetPosition({0.f, 2.f, 0.f});
...
//	for (uint32_t i = 0; i < mBones.size(); ++i)
//	{	
//		//mBones[i].transform.Scaling(tempCubeScale);
...
//
//	tempScale = { 0.25, 1.0, 0.25f };
//	for (uint32_t i = 0; i < mBones.size(); i++)
//	{
//		tempMatrix = mBoneWorldTransform[i];
//		data.wvp = Math::Transpose(tempMatrix * view * projection);
//	}
...
//
//Homework:
//create a box tentical then a cylinder that can bend
//
//*/